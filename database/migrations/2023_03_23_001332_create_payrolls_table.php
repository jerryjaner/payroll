...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('payrolls', function (Blueprint $table) {
            ...
            $table->decimal('leave_without_pay', 15,2)->default(0.00);
            $table->decimal('voluntary_time_off', 15,2)->default(0.00);
            $table->decimal('suspended', 15,2)->default(0.00);
            ...
            $table->decimal('thirteen_month', 15,2)->default(0.00);
